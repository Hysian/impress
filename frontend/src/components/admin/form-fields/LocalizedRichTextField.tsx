      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <textarea
            ...
            disabled={disabled}
            rows={4}
            className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:bg-gray-100 disabled:cursor-not-allowed resize-y"
            placeholder="请输入中文..."
          />
        </div>
        <div>
