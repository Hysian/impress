...
func TestLoad_MissingDBDSN(t *testing.T) {
  ...
  expectedMsg := "missing required environment variables: [DB_DSN]"
...
func TestLoad_MissingMultipleVars(t *testing.T) {
  ...
  // Should contain all three missing vars
  if err.Error() != "missing required environment variables: [DB_DSN JWT_SECRET JWT_REFRESH_SECRET]" {
